					...
					<div class="col-xs-12">
						...
						<table class="table">
							...
							<s:iterator value="pager.list" status="i" var="item">
								<tr>
									<td>
										<a href="<%=request.getContextPath() %>/news/<s:property escape="false" value="id"/>.html" title="<s:property escape="false" value="title"/>">
											<s:property escape="false" value="title" />
										</a>
									</td>
									<td>
										<s:property escape="false" value="createtime" />
									</td>
								</tr>
							</s:iterator>
						</table>
