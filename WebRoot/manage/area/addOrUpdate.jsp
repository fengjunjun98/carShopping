...
<s:form action="menu" name="form1" namespace="/manage" theme="simple">
		...
		<table id="result_table1" class="table table-bordered" style="width: 500px;margin: auto;margin-top: 20px;">
			...
			<tr>
				<td>id</td>
				<td>
					<input id="input_parent_id" readonly="readonly" value='<s:property value="e.id"/>'/>
				</td>
			</tr>
			<tr>
				<td>code</td>
				<td>
					<input id="input_parent_code" readonly="readonly" value='<s:property value="e.code"/>'/>
				</td>
			</tr>
			<tr>
				<th>pcode</th>
				<td style="text-align: left;">
					<input id="input_parent_pcode" readonly="readonly" value='<s:property value="e.pcode"/>'/>
				</td>
			</tr>
			<tr>
				<th>名称</th>
				<td style="text-align: left;">
					<input id="input_parent_name" size="80" value='<s:property value="e.name"/>'/>
				</td>
			</tr>
		</table>
		<!-- item -->
		...
		<table class="table table-bordered" style="width: 500px;margin: auto;margin-top: 20px;">
			...
			<tr>
				<th>类型</th>
				<td style="text-align: left;">
					<s:select list="#{'children':'子项','top':'顶级'}" id="input_children_type" name="e.type" onchange="changeType()"
			...
			<tr>
				...
				<td>
					<input id="input_children_pcode" readonly="readonly" value='<s:property value="e.code"/>'/>
				</td>
			</tr>
			<tr>
				<td>code</td>
