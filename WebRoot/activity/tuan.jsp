...
<body >
	<%
	request.getSession().setAttribute(net.carshopping.core.FrontContainer.selectMenu, "tuan");
	%>
	...
	<div class="container" >
		<div class="row">
			...
			<div class="col-xs-9" style="margin-top: -10px;">
				<%String indexProductListUrl = "/activity/activityTuan_common_productList.jsp?queryType=j";%>
