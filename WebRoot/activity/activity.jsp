...
<body >
	<%
	request.getSession().setAttribute(net.carshopping.core.FrontContainer.selectMenu, "activity");
	%>
	...
	<div class="container" >
		<div class="row">
			...
			<div class="col-xs-9" style="margin-top: -10px;">
				<%String indexProductListUrl = "/activity/activity_common_productList.jsp?queryType=r";%>
				<jsp:include flush="true" page="<%=indexProductListUrl %>"></jsp:include>
				
				<%indexProductListUrl = "/activity/activity_common_productList.jsp?queryType=d";%>
				<jsp:include flush="true" page="<%=indexProductListUrl %>"></jsp:include>
				
				<%indexProductListUrl = "/activity/activity_common_productList.jsp?queryType=s";%>
				<jsp:include flush="true" page="<%=indexProductListUrl %>"></jsp:include>
