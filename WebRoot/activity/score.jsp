...
<body >
	<%
	request.getSession().setAttribute(net.carshopping.core.FrontContainer.selectMenu, "score");
	%>
	...
	<div class="container" >
		<div class="row">
			...
			<div class="col-xs-9" style="margin-top: -10px;">
				<%String indexProductListUrl = "/activity/activityScore_common_productList.jsp?queryType=j";%>
