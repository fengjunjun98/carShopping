		...
		<s:iterator value="e.productImageList" status="i" var="img">
			...
			<s:else>
				...
				<div class="tb-pic tb-s40" style="width: 50px;height: 50px;">    
					<a href="#"><img style="max-width: 50px;max-height: 50px;" src="<%=SystemManager.systemSetting.getImageRootPath()%><s:property escape="false" value="image1" />" 
					mid="<%=SystemManager.systemSetting.getImageRootPath()%><s:property escape="false" value="image2" />" 
					big="<%=SystemManager.systemSetting.getImageRootPath()%><s:property escape="false" value="image3" />"></a>
				</div>
			</li>
		</s:iterator>
	</ul>
