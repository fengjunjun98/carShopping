		...
		<div class="t1">
			...
			<div id="showArea">
				<s:iterator value="e.productImageList" status="i" var="img">
					<a href="<%=SystemManager.systemSetting.getImageRootPath()%><s:property escape="false" value="image3" />" rel="zoom1" rev="<%=SystemManager.systemSetting.getImageRootPath()%><s:property escape="false" value="image2" />">
			<img src="<%=SystemManager.systemSetting.getImageRootPath()%><s:property escape="false" value="image1" />" /></a>	
			   </s:iterator>
			</div>
			<img src="<%=request.getContextPath() %>/resource/js/showProduct/images/gobottom.gif" id="gobottom"  />
		</div>
		<div class="t2">
		<a href="<%=SystemManager.systemSetting.getImageRootPath()%><s:property escape="false" value="e.picture" />" id="zoom1" class="MagicZoom MagicThumb">
			<img src="<%=SystemManager.systemSetting.getImageRootPath()%><s:property escape="false" value="e.picture" />" 
