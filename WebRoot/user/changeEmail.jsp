<%@page import="net.carshopping.core.util.TokenUtil"%>
					...
					<div class="col-xs-12" style="font-size: 14px;font-weight: normal;">
						<div class="panel panel-default">
				              <div class="panel-body" style="font-size: 16px;font-weight: normal;text-align: center;">
				              		<s:form role="form" id="form" cssClass="form-horizontal" action="/user/doChangeEmail.html" theme="simple">   
									  ...
									  <div class="form-group">
									    ...
									    <div class="col-lg-6">
										    <s:textfield name="e.password" type="text" cssClass="form-control" id="password" 
									  ...
									  <div class="form-group">
									    ...
									    <div class="col-lg-6">
										    <s:textfield name="e.newEmail" type="text" cssClass="form-control" id="newEmail" 
									  ...
									  <div class="form-group">
									    <div class="col-lg-offset-2 col-lg-6">
									      <s:submit type="submit" cssClass="btn btn-success btn-sm" value="提交"/>
									    </div>
									  </div>
									</s:form>
				              </div>
