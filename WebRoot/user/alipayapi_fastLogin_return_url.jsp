...
<%@page import="net.carshopping.web.action.manage.account.AccountAction"%>
<%@page import="org.slf4j.LoggerFactory"%>
<%@page import="org.slf4j.Logger"%>
<%@page import="net.carshopping.services.front.account.AccountService"%>
<%@page
	import="org.springframework.web.context.support.WebApplicationContextUtils"%>
<%@page import="org.springframework.web.context.WebApplicationContext"%>
<%@page import="net.carshopping.core.front.SystemManager"%>
<%@page import="net.carshopping.services.front.account.bean.LoginTypeEnum"%>
<%@page import="net.carshopping.services.front.account.bean.Account"%>
<%@page import="net.carshopping.core.ManageContainer"%>
<%@page import="net.carshopping.core.pay.alipay.alipayescow.util.AlipayNotify"%>
<%
	/* *
	 功能：支付宝页面跳转同步通知页面
	 版本：3.2
