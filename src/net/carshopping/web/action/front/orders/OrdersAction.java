/** * 文件名：OrdersAction.java 
 * * 版本信息： 
 * 日期：2015-2-6 
 * Copyright: Corporation 2015 
 * 版权所有 * */
package net.carshopping.web.action.front.orders;
...
import net.carshopping.core.kuaidi100Helper;
...
import net.carshopping.services.front.orderdetail.OrderdetailService;
import net.carshopping.services.front.orderdetail.bean.Orderdetail;
import net.carshopping.services.front.orderpay.OrderpayService;
import net.carshopping.services.front.orderpay.bean.Orderpay;
import net.carshopping.services.front.ordership.OrdershipService;
import net.carshopping.services.front.ordership.bean.Ordership;
 ...
 * 创建人：凤军军
 * 创建时间：2015-2-6 下午02:20:38 
 * 修改人：凤军军 
 * 修改时间：2015-2-6 下午02:20:38 
 * 修改备注：
 * @version 1.0* */
...
//		}
		...
		synchronized (SystemManager.product_stock_lock) {
			...
			if(no){
				...
				getResponse().sendRedirect("confirmOrder.html");
				return null;
			}
