package net.carshopping.core.oscache;
...
import net.carshopping.services.front.advert.AdvertService;
import net.carshopping.services.front.advert.bean.Advert;
import net.carshopping.services.front.area.AreaService;
import net.carshopping.services.front.area.bean.Area;
import net.carshopping.services.front.attribute.AttributeService;
import net.carshopping.services.front.attribute.bean.Attribute;
import net.carshopping.services.front.catalog.CatalogService;
import net.carshopping.services.front.catalog.bean.Catalog;
import net.carshopping.services.front.comment.CommentService;
import net.carshopping.services.front.commentType.CommentTypeService;
import net.carshopping.services.front.commentType.bean.CommentType;
import net.carshopping.services.front.express.ExpressService;
import net.carshopping.services.front.express.bean.Express;
...
import net.carshopping.services.front.keyvalue.KeyvalueService;
import net.carshopping.services.front.keyvalue.bean.Keyvalue;
...
import net.carshopping.services.front.notifyTemplate.NotifyTemplateService;
...
import net.carshopping.services.front.pay.PayService;
import net.carshopping.services.front.pay.bean.Pay;
...
import net.carshopping.services.front.systemSetting.SystemSettingService;
import net.carshopping.services.front.systemSetting.bean.SystemSetting;
