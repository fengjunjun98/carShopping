 ...
 * 创建人：凤军军
 * 创建时间：2015-1-21 下午07:27:31 
 * 修改人：凤军军 
 * 修改时间：2015-1-21 下午07:27:31 
 * 修改备注：
 * @version 1.0* */
...
public class TaskManager {
	...
	// 秒钟
	// private static final long task_default_seconds_time =
	// Integer.valueOf(SystemManager.getInstance().get("task_default_seconds_time"));
	...
	public void start() {
		...
		// for(Iterator<Entry<String, Task>> it =
		// taskPool.entrySet().iterator();it.hasNext();){
